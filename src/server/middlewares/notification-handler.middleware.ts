...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'appointment.create': {
    roles: ['dentist', 'dental-assistant', 'office-manager', 'receptionist'],
    key: 'new-appointment',
  ...
  'treatment.create': {
    roles: ['dentist', 'dental-assistant', 'office-manager'],
    key: 'new-treatment-plan',
    tenantPath: ['practice', 'appointment', 'patient', 'treatment'],
    userPath: [],
  },
};

const ownerRoles: string[] = ['dentist'];
const customerRoles: string[] = ['customer'];
const tenantRoles: string[] = ['dentist', 'dental-assistant', 'office-manager', 'receptionist'];
